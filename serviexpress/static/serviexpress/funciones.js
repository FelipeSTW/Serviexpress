...
export function nuevaReserva(e) {
    ...
    const { fecha, hora, nombre , telefono, servicio } = reservaObj;

    //validar

    if( fecha === '' || hora === '' || nombre === '' || telefono === '' || servicio === '') {
