...
class UI {
    ...
    imprimirReservas() {
                     ...
                     const { fecha, hora, nombre , telefono, servicio, id } = cursor.value;
                        ...
                        ServicioCliente.classList.add('text-secondary')
                        ServicioCliente.innerHTML = `
                        <span class="font-weight-bolder">Servicio Cliente: </span> ${servicio}
                        ...
                        divReserva.appendChild(ServicioCliente); 
